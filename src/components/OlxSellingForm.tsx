        ...
        <div className="bg-white rounded-md shadow-sm">
          ...
          <div className="border-b border-gray-200 p-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="text-blue-800 text-sm font-medium flex items-center border-b-2">
                Change
              </button>
            </div>
          </div>
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {propertyTypes.map((type) => (
                    <button
                      ...
                      className={`p-2 text-sm border rounded-md text-left hover:bg-blue-500/20 ${
                        formData.type === type
                ...
                <div className="flex flex-wrap gap-2">
                  {furnishingOptions.map((option) => (
                    <button
                      key={option}
                      type="button"
                      onClick={() => handleInputChange("furnishing", option)}
                ...
                <div className="flex flex-wrap gap-2">
                  {projectStatusOptions.map((status) => (
                    <button
                      key={status}
                      type="button"
                      onClick={() => handleInputChange("projectStatus", status)}
                      className={`px-4 py-2 text-sm border rounded-md ${
                ...
                <div className="flex flex-wrap gap-2">
                  {listedByOptions.map((option) => (
                    <button
                      key={option}
                      type="button"
                      onClick={() => handleInputChange("listedBy", option)}
                      className={`px-4 py-2 text-sm border rounded-md ${
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("floorNo", parseInt(e.target.value) || 0)
                  }
                  className={`w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                ...
                <div className="flex flex-wrap gap-2">
                  {carParkingOptions.map((option) => (
                    <button
                      key={option}
                      type="button"
                      onClick={() => handleInputChange("carParking", option)}
                      className={`px-6 py-2 text-sm border rounded-sm ${
              ...
              <div>
                ...
                {errors.adTitle && (
                  <p className="text-red-500 text-sm mt-1">{errors.adTitle}</p>
                )}
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center justify-start gap-2">
                ...
                {imagePreviews.map((preview, index) => (
                  <div key={index} className="relative aspect-square w-20 h-20">
                    <img
                      src={preview}
                      alt={`Preview ${index + 1}`}
